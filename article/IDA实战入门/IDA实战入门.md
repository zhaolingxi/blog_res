...
![pingins_use_1](photo/pingins_use_1.png)
...
### 调用函数时的内存分布
![运行时内存](photo/运行时内存.png)

### 函数变量与参数
![变量与参数1](photo/变量与参数1.png)
![变量与参数2](photo/变量与参数2.png)
...
![32dll_funA](photo/32dll_funA.png)
